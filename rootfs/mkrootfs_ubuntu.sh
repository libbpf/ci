#!/bin/bash
# This script builds an Ubuntu root filesystem image for testing libbpf in a
...
function check_requirements() {
    ...
    then
        error "mmdebstrap binary not found on your system. Make sure debootstrap package is installed."
        err=1
    fi
